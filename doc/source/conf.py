#
# StarterPyth documentation build configuration file, created by
...
from starterpyth import __version__ as version_orig
...
# documentation.
# html_theme_options = dict(bgcolor='#FCFCFC; background: #FCFCFC url("fond_article.png") no-repeat center 10em; ')
...
htmlhelp_basename = 'StarterPythdoc'
